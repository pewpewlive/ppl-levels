...
function helper.add_cube_to_mesh(mesh, center, side_length, color) -- mesh, center, side_length, color, here it shows what it needs so we give it in 1.lua
...
function helper.add_rectangle_to_mesh(mesh, center, width, height, depth, color)
  local halfW = width / 2
  ...
  local a = {x - halfW, y - halfH, z - halfD}
  local b = {x - halfW, y + halfH, z - halfD}
  local c = {x + halfW, y + halfH, z - halfD}
  local d = {x + halfW, y - halfH, z - halfD}
  local e = {x - halfW, y - halfH, z + halfD}
  local f = {x - halfW, y + halfH, z + halfD}
  local g = {x + halfW, y + halfH, z + halfD}
  local h = {x + halfW, y - halfH, z + halfD}
