...
function helper.spawn_away_from_players(current_x, current_y)
...
function helper.deal_damage_to_player(damage)
  for i = 1, #helper.player_ships do
    pewpew.add_damage_to_player_ship(helper.player_ships[i], damage)
    table.remove(helper.player_ships, i)
  end
end
