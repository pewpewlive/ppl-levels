...
function helper.add_BAF_Right(mesh,center,color,forward,backward,upward)
  local x = center[1]
  local y = center[2]
  local z = center[3]
  local vertices = {}

  table.insert(vertices,{x + forward, y, z})
  table.insert(vertices,{x, y, z})
  table.insert(vertices,{x - backward, y + upward, z})
  helper.add_line_to_mesh(mesh, vertices, {color,color,color},true)
  vertices = {}
  ...
  table.insert(vertices,{x + forward, y, z})
  table.insert(vertices,{x, y, z})
  table.insert(vertices,{x - backward, y, z + upward})
  helper.add_line_to_mesh(mesh, vertices, {color,color,color},true)
  vertices = {}
...
function helper.add_BAF_Left(mesh,center,color,forward,backward,upward)
  local x = center[1]
  local y = center[2]
  local z = center[3]
  local vertices = {}
...
function helper.add_BAF_Up(mesh,center,color,forward,backward,upward)
  local x = center[1]
  local y = center[2]
  local z = center[3]
  local vertices = {}

  table.insert(vertices,{x, y + forward, z})
  table.insert(vertices,{x, y, z})
  table.insert(vertices,{x + upward, y - backward, z})
  helper.add_line_to_mesh(mesh, vertices, {color,color,color},true)
  vertices = {}
  ...
  table.insert(vertices,{x, y + forward, z})
  table.insert(vertices,{x, y, z})
  table.insert(vertices,{x, y - backward, z + upward})
  helper.add_line_to_mesh(mesh, vertices, {color,color,color},true)
  vertices = {}
...
function helper.add_BAF_Down(mesh,center,color,forward,backward,upward)
  local x = center[1]
  local y = center[2]
  local z = center[3]
  local vertices = {}
