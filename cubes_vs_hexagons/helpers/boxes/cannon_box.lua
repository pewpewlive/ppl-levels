    ...
    function(player_id, entity_id)
      ...
      pewpew.add_update_callback(function()
        ...
        if time == duration + 1 then
          if pewpew.get_player_configuration(0)["has_lost"] == false then
            pewpew.configure_player_ship_weapon(entity_id, {frequency = pewpew.CannonFrequency.FREQ_7_5, cannon = pewpew.CannonType.TRIPLE, duration=999999999})
          end
        end
      end)
    end, 400)
