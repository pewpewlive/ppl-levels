...
for i = 1fx, bg_amount, 1fx do
  ...
  if i == 1fx then
    pewpew.customizable_entity_configure_music_response(id, {scale_z_start = 1.3072fx, scale_z_end = 2fx})
  elseif i == 2fx then
    pewpew.customizable_entity_configure_music_response(id, {scale_z_start = 1.2048fx, scale_z_end = 1.3072fx})
  elseif i == 3fx then
    pewpew.customizable_entity_configure_music_response(id, {scale_z_start = 1.2048fx, scale_z_end = 2fx})
  end
end
...
for i = 1fx, bg_amount, 1fx do
  ...
  pewpew.customizable_entity_set_mesh_z(id, (bg_amount / 2fx - i + 1fx) * bg_z_distance)
  pewpew.customizable_entity_configure_music_response(id, {scale_z_start = 1.200fx, scale_z_end = 0.3900fx})
end
