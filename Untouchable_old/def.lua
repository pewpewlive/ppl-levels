...
local __new_entity = pewpew.new_customizable_entity
pewpew.new_customizable_entity = function(x, y)
  return __new_entity(x, y) or 1
end

local __new_player_bullet = pewpew.new_player_bullet
pewpew.new_player_bullet = function(x, y, angle, index)
  return __new_player_bullet(x, y, angle, 0) or 1
end
